"""Variable selection for the Binary Prediction problem

This script contains the code that was used to select input variables of multivariate models in the binary prediction problem
...
output_path = "../../Data/Output/BinaryPrediction/binary_var_selection"
...
parameter_selection_path = "../../Data/Output/BinaryPrediction/binary_par_tuning/evaluation.csv"
...
for model_name in models:
    ...
    for iteration in range(1,max_iteration+1):
        ...
        eval_iter = concat(eval_list_iter).reset_index().dropna(axis = 0)
