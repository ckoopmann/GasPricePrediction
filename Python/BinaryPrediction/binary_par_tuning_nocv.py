"""Univariate Parameter Tuning for the Binary Prediction problem

This script contains the code that was used to tune the hyper parameters of univariate models in the binary prediction problem
...
output_path = "../../Data/Output/BinaryPrediction/binary_par_tuning"
