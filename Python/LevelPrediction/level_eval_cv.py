"""Model evaluation for the Price Level Prediction problem

This script contains the code that was used to evaluate uni- and multivariate models in the price level prediction problem
