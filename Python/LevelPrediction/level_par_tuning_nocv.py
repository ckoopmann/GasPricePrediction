"""Univariate Parameter Tuning for the Price Level Prediction problem

This script contains the code that was used to tune the hyper parameters of univariate models in the price level prediction problem
This should be the first script to run among the scripts in this directory
...
for model_name in models:
    ...
    print(y_train.shape)
    print(y_test.shape)
    #Begin parameter tuningn by looping through combinations
